...
internal static class Common
{
    public record PropertyInfo(
        string Name, ITypeSymbol Type, INamedTypeSymbol ComponentSymbol, string DisplayType,
        ImmutableArray<string> TypeArguments, ImmutableDictionary<string, TypedConstant> Arguments)
    {
        ...
        public PropertyInfo(string name, ITypeSymbol symbol, INamedTypeSymbol componentSymbol, IEnumerable<AttributeData> attributes)
            : this(name, symbol, componentSymbol, GetDisplayName(symbol),
