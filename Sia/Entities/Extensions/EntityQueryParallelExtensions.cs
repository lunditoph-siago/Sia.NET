...
public static class EntityQueryParallelExtensions
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public unsafe static void Record(this IEntityQuery query, Span<EntityRef> array)
    {
        int index = 0;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public unsafe static void Record<TResult>(
        this IEntityQuery query, Span<TResult> span, RecordFunc<TResult> recordFunc)
    {
        int index = 0;
        foreach (var entity in query) {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public unsafe static void Record<TData, TResult>(
        this IEntityQuery query, in TData data, Span<TResult> span, RecordFunc<TData, TResult> recordFunc)
    {
        int index = 0;
        foreach (var entity in query) {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public unsafe static int Record<TResult>(
        this IEntityQuery query, Span<TResult> span, CondRecordFunc<TResult> recordFunc)
    {
        int index = 0;
        foreach (var entity in query) {
    ...
    public unsafe static int Record<TData, TResult>(
        this IEntityQuery query, in TData data, Span<TResult> span, CondRecordFunc<TData, TResult> recordFunc)
    {
        int index = 0;
        foreach (var entity in query) {
